...
const steps = [
  ...
  { image: step2, description: " Next, put your phone no.and click  on continue." },
  { image: step3, description: "Fill in the information and click on the continue button." },
  { image: step4, description: "Confirm the OTP and click on continue." },
  { image: step5, description: "After signing up, start with the first step with filling pan detail and DOB." },
  { image: step6, description: " In step 2 pay account opening fee which is the minimum balance to open Zerodha account." },
  { image: step7, description: "Now, it's time to share your aadhar KYC continue to digilocker" },
    { image: step8, description: "Enter your aadhaar and click on continue." },
    { image: step9, description: "Verify  your aadhar OTP" },
    { image: step10, description: " Next, fill the requested information here to make a profile." },
    { image: step11, description: "Here you have to link your bank account." },
    { image: step12, description: "Now it’s time for webcam verification which is an important step to complete your demat account." },
    { image: step13, description: "Upload digital signature or E Signature." },
    { image: step14, description: "This is the last process where you have to collect required account opening documentation." },
